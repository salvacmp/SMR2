...
class App:
    def __init__(self, root):
        ...
        # self.roi_polygon = [(228, 186), (238, 468), (480, 468), (471, 186)]
        self.roi_polygon = [(153, 415), (404, 392), (408, 212), (211, 212)]
    ...
    def update_camera_feed(self):
        while self.running:
            ...
            #YOLO
            cv2.circle(annotated_frame, (153, 415), 5, (0, 0, 255), -1)
            cv2.circle(annotated_frame, (405, 391), 5, (0, 0, 255), -1)
            cv2.circle(annotated_frame, (407, 212), 5, (0, 0, 255), -1)
            cv2.circle(annotated_frame, (213, 213), 5, (0, 0, 255), -1)
            ...
            if obbs is not None:
                ...
                for obb in obbs.data.cpu().numpy():
                    ...
                    #detection square
                    if confidence >= 0.55:
                        if self.is_point_in_polygon((x_center, y_center), self.roi_polygon):
